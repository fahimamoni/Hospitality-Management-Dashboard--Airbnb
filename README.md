...
**Geographical Performance:** Identifies the "Top 10 Countries by Revenue" (with Portugal leading by a significant margin).

**Channel Performance:** Breaks down revenue and losses by distribution channels (Corporate, Direct, Offline, and Online Travel Agents).

**Cancellation Analysis:** Examines how the Average Daily Rate (ADR) and Lead Time (booking in advance) impact cancellation percentages.
